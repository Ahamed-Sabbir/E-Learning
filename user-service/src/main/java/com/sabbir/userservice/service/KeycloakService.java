...
public class KeycloakService {
    ...
    public UUID registerNewUser(User user) throws Exception {
        ...
        /**
         * By default, Keycloak doesn't create a password for user, it needs to be updated
         * By default, Keycloak doesn't create a role for user, it needs to be updated
